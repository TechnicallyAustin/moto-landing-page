...
import Moto from '../../assets/images/moto-home.avif'
            ...
            <figure id="" className='w-full h-full p-3 border flex flex-col'>
                <figcaption className=' relative z-20 top-40 w-full h-auto flex flex-col gap-3'>
                    ...
                    <article className='relative top-1/4 w-full h-full flex justify-center items-center gap-3'>
                        <button className='w-full p-3 px-2 h-full text-xl flex justify-center items-center rounded-lg bg-danger shadow shadow-lg'>Services</button>
                ...
                <img className='w-full h-full object-cover absolute top-0 left-0 z-10' src={Moto} alt="motorcyle and mechanic"/>
            </figure>
