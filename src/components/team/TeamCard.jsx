...
import Port from "../../../public/images/tech-port.jpeg";
import TwitterIcon from "../../../public/icons/XIcon";
    ...
    <section className="w-full h-1/6 flex shadow-danger shadow-lg rounded-lg  flex">
      <figure className="w-full h-full  flex flex-col gap-1">
        <img
          ...
          alt=""
          src={Port}
          className="w-full h-3/4  shadow object-cover aspect-square rounded-t-lg"
        />
        <figcaption className="w-full h-full grid grid-cols-max  px-3 p-1 justify-between place-items-center">
          <h3 className="w-full h-full font-bold col-start-1 flex items-center">
            Member Name
          </h3>
